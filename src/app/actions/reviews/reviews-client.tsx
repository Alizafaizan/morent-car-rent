  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="bg-blue-100 text-blue-600 text-sm font-medium px-3 py-1 rounded-full">{reviews.length}</span>
      </div>
      <div className="space-y-6">
        {displayedReviews.map((review) => (
          <div key={review.id} className="flex flex-col md:flex-row md:items-start gap-4">
