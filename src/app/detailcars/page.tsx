...
//               <li className="text-[rgba(89,103,128,100%)] font-semibold">
//                 {" "}
//                 <input type="checkbox" /> Sport{" "}
//                 <span className="text-[rgba(144,163,191,100%)] text-[14px]">
//                   (10)
//                 </span>
//               </li>
//               <li className="text-[rgba(89,103,128,100%)] font-semibold">
...
//             <h1 className="text-[rgba(89,103,128,100%)] font-semibold text-[14px]">
//               Max. $100.00
//             </h1>
//           </div>
//         </div>
...
//               <div>
//                 <h1 className="font-semibold font-[PlusJakartaSans] text-[16px] text-[rgba(144,163,191,100%)]">
//                   Recent Car
//                 </h1>
//               </div>
//               <div>
...
//                 <div className="flex justify-between">
//                   <div>
//                     <h1 className="font-bold text-[rgba(26,32,44,100%)] text-[16px]">
//                       Koenigsegg
//                     </h1>
//                   </div>
//                   <div>
...
//                 <div>
//                   <h1 className="text-[rgba(89,103,128,100%)] font-bold text-[14px]">
//                     Sport
//                   </h1>
//                 </div>
...
//                       $99.0/
//                       <span className="text-[14px] text-[rgba(26,32,44,100%)]">
//                         day
//                       </span>
//                     </h1>
//                   </div>
...
//                   <Link href={"/billing"}>
//                     <button className="bg-[#3563E9] text-white rounded-md px-6 py-2">
//                       Rent Now
//                     </button>
//                   </Link>
//                 </div>
...
//                       </span>
//                     </h1>
//                     <h1 className="text-[rgba(89,103,128,100%)] line-through font-[14px]">
//                       $80.0
//                     </h1>
//                   </div>
