...
const PickDropSection: React.FC = () => {
  ...
  const RentalSection: React.FC<{ type: RentalType }> = ({
    type,
  }) => {
    const isPickup = type === "pickup";
    const city = isPickup ? pickupCity : dropoffCity;
  ...
  return (
    <div className="px-4 py-8 flex flex-col lg:flex-row items-center bg-[#F6F7F9] space-y-4 lg:space-x-4">
      <RentalSection type="pickup" />
      <Button onClick={handleSwap} size="icon" className="bg-blue-600 hover:bg-blue-500">
